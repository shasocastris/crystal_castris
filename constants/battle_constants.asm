...
; Unown DVs
DEF ATKDEFDV_UNOWN_A EQU $99
DEF SPDSPCDV_UNOWN_A EQU $DB
DEF ATKDEFDV_UNOWN_B EQU $9B
DEF SPDSPCDV_UNOWN_B EQU $9F
DEF ATKDEFDV_UNOWN_C EQU $9B
DEF SPDSPCDV_UNOWN_C EQU $FB
DEF ATKDEFDV_UNOWN_D EQU $9D
DEF SPDSPCDV_UNOWN_D EQU $BF
DEF ATKDEFDV_UNOWN_E EQU $9F
DEF SPDSPCDV_UNOWN_E EQU $9B
DEF ATKDEFDV_UNOWN_F EQU $9F
DEF SPDSPCDV_UNOWN_F EQU $DF
DEF ATKDEFDV_UNOWN_G EQU $B9
DEF SPDSPCDV_UNOWN_G EQU $BB
DEF ATKDEFDV_UNOWN_H EQU $B9
DEF SPDSPCDV_UNOWN_H EQU $FF
DEF ATKDEFDV_UNOWN_I EQU $BB
DEF SPDSPCDV_UNOWN_I EQU $DB
DEF ATKDEFDV_UNOWN_J EQU $BD
DEF SPDSPCDV_UNOWN_J EQU $9F
DEF ATKDEFDV_UNOWN_K EQU $BD
DEF SPDSPCDV_UNOWN_K EQU $FB
DEF ATKDEFDV_UNOWN_L EQU $BF
DEF SPDSPCDV_UNOWN_L EQU $BF
DEF ATKDEFDV_UNOWN_M EQU $D9
DEF SPDSPCDV_UNOWN_M EQU $9B
DEF ATKDEFDV_UNOWN_N EQU $D9
DEF SPDSPCDV_UNOWN_N EQU $DF
DEF ATKDEFDV_UNOWN_O EQU $DB
DEF SPDSPCDV_UNOWN_O EQU $BB
DEF ATKDEFDV_UNOWN_P EQU $DB
DEF SPDSPCDV_UNOWN_P EQU $FF
DEF ATKDEFDV_UNOWN_Q EQU $DD
DEF SPDSPCDV_UNOWN_Q EQU $DB
DEF ATKDEFDV_UNOWN_R EQU $DF
DEF SPDSPCDV_UNOWN_R EQU $9F
DEF ATKDEFDV_UNOWN_S EQU $DF
DEF SPDSPCDV_UNOWN_S EQU $FB
DEF ATKDEFDV_UNOWN_T EQU $F9
DEF SPDSPCDV_UNOWN_T EQU $BF
DEF ATKDEFDV_UNOWN_U EQU $FB
DEF SPDSPCDV_UNOWN_U EQU $9B
DEF ATKDEFDV_UNOWN_V EQU $FB
DEF SPDSPCDV_UNOWN_V EQU $DF
DEF ATKDEFDV_UNOWN_W EQU $FD
DEF SPDSPCDV_UNOWN_W EQU $BB
DEF ATKDEFDV_UNOWN_X EQU $FD
DEF SPDSPCDV_UNOWN_X EQU $FF
DEF ATKDEFDV_UNOWN_Y EQU $FF
DEF SPDSPCDV_UNOWN_Y EQU $DB
DEF ATKDEFDV_UNOWN_Z EQU $FF
DEF SPDSPCDV_UNOWN_Z EQU $FF
...
; battle types (wBattleType values)
	...
	const BATTLETYPE_UNOWN_A
	const BATTLETYPE_UNOWN_B
	const BATTLETYPE_UNOWN_C
	const BATTLETYPE_UNOWN_D
	const BATTLETYPE_UNOWN_E
	const BATTLETYPE_UNOWN_F
	const BATTLETYPE_UNOWN_G
	const BATTLETYPE_UNOWN_H
	const BATTLETYPE_UNOWN_I
	const BATTLETYPE_UNOWN_J
	const BATTLETYPE_UNOWN_K
	const BATTLETYPE_UNOWN_L
	const BATTLETYPE_UNOWN_M
	const BATTLETYPE_UNOWN_N
	const BATTLETYPE_UNOWN_O
	const BATTLETYPE_UNOWN_P
	const BATTLETYPE_UNOWN_Q
	const BATTLETYPE_UNOWN_R
	const BATTLETYPE_UNOWN_S
	const BATTLETYPE_UNOWN_T
	const BATTLETYPE_UNOWN_U
	const BATTLETYPE_UNOWN_V
	const BATTLETYPE_UNOWN_W
	const BATTLETYPE_UNOWN_X
	const BATTLETYPE_UNOWN_Y
	const BATTLETYPE_UNOWN_Z
