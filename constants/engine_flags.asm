...
; wDailyFlags3
	...
	const ENGINE_UNUSED_FLAG_2
	const ENGINE_UNUSED_FLAG_3
	const ENGINE_UNUSED_FLAG_4
	const ENGINE_UNUSED_FLAG_5
	const ENGINE_UNUSED_FLAG_6
	const ENGINE_UNUSED_FLAG_7
; wDailyFlags4
	const ENGINE_BEAT_FALKNER
	const ENGINE_BEAT_BUGSY
	const ENGINE_BEAT_WHITNEY
	const ENGINE_BEAT_MORTY
	const ENGINE_BEAT_CHUCK
	const ENGINE_BEAT_JASMINE
	const ENGINE_BEAT_PRYCE
	const ENGINE_BEAT_CLAIR
; wDailyFlags5
	const ENGINE_BEAT_BROCK
	const ENGINE_BEAT_MISTY
	const ENGINE_BEAT_LTSURGE
	const ENGINE_BEAT_ERIKA
	const ENGINE_BEAT_JANINE
	const ENGINE_BEAT_SABRINA
	const ENGINE_BEAT_BLAINE
	const ENGINE_BEAT_BLUE
; wSwarmFlags
...
; wDailyPhoneItemFlags
	...
	const ENGINE_TIFFANY_HAS_SILVERPOWDER
