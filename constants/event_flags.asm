...
; HMs (EVENT_GOT_HM07_WATERFALL is with the Johto itemballs)
	...
	const EVENT_GOT_HM08_ROCK_SMASH
; Rods
...
; Johto story events
	...
	const EVENT_SPOKE_WITH_ROUTE_36_RANGER
	const EVENT_CLEARED_SLOWPOKE_WELL
	const EVENT_REFUSED_TO_TAKE_TOGEPI_FROM_ELMS_AIDE
	const EVENT_GOT_TOGEPI_FROM_ELMS_AIDE
	...
	const EVENT_KURT_GAVE_YOU_EXP_SHARE
	...
	const EVENT_BEAT_ELITE_FOUR_FINAL
	const EVENT_GOT_SHUCKIE
	const EVENT_RETURNED_SHUCKIE_TO_MANIA
	...
	const EVENT_GOT_EON_MAIL_FROM_RANDY
	const EVENT_GOT_TM50_NIGHTMARE
	const EVENT_TOGEPI_EVOLVED
	const EVENT_SHOWED_TOGETIC_TO_ELM
	const EVENT_GOT_MIST_STONE_FROM_ELM
	...
	const EVENT_GOT_POLKADOT_BOW_FROM_TUSCANY
	...
	const EVENT_TOLD_ELM_ABOUT_TOGETIC_OVER_THE_PHONE
	...
	const EVENT_GOT_MASTER_BALL_FROM_MARY
	const EVENT_GOT_BLACKTHORN_RANGER_STATION_MACHETE
	const EVENT_GOT_PEWTER_GRAMPS_JACKHAMMER
; Johto hidden items
	const EVENT_TIN_TOWER_4F_HIDDEN_MAX_POTION
	const EVENT_TIN_TOWER_5F_HIDDEN_FULL_RESTORE
	const EVENT_TIN_TOWER_5F_HIDDEN_CARBOS
	const EVENT_BURNED_TOWER_1F_HIDDEN_MIST_STONE
	const EVENT_SILVER_CAVE_UNDERBELLY_HIDDEN_SACRED_ASH
	const EVENT_SILVER_CAVE_UNDERBELLY_HIDDEN_FULL_RESTORE
	const EVENT_SILVER_CAVE_UNDERBELLY_HIDDEN_ELIXER
	...
	const EVENT_ILEX_FOREST_HIDDEN_MIST_STONE
	...
	const EVENT_SAFFRON_UNDERGROUND_SWITCH_ROOM_HIDDEN_MAX_POTION
	const EVENT_SAFFRON_UNDERGROUND_SWITCH_ROOM_HIDDEN_REVIVE
	...
	const EVENT_DARK_CAVE_VIOLET_ENTRANCE_HIDDEN_MOON_STONE
	const EVENT_DARK_CAVE_VIOLET_ENTRANCE_HIDDEN_METAL_COAT
	...
	const EVENT_ROUTE_30_HIDDEN_LURE_BALL
...
; Crystal-exclusive events in Johto
	...
	const EVENT_ECRUTEAK_WILD_HUNT
	const EVENT_ROUTE38_GATE_RANGERS
	const EVENT_QUELLED_WILD_HUNT
	const EVENT_TAUROS_HERD_LEADER
	const EVENT_FOUGHT_WILD_HUNT_TAUROS_1
	const EVENT_FOUGHT_WILD_HUNT_TAUROS_2
	const EVENT_FOUGHT_WILD_HUNT_TAUROS_3
	const EVENT_FOUGHT_WILD_HUNT_TAUROS_4
	const EVENT_FOUGHT_WILD_HUNT_TAUROS_5
	const EVENT_FOUGHT_WILD_HUNT_TAUROS_6
	const EVENT_FOUGHT_WILD_HUNT_TAUROS_7
	const EVENT_FOUGHT_WILD_HUNT_TAUROS_8
	const EVENT_FOUGHT_WILD_HUNT_TAUROS_9
	const EVENT_FOUGHT_WILD_HUNT_TAUROS_10
	const EVENT_FOUGHT_WILD_HUNT_TAUROS_11
	const EVENT_FOUGHT_WILD_HUNT_TAUROS_12
	const EVENT_FOUGHT_WILD_HUNT_TAUROS_13
	const EVENT_FOUGHT_WILD_HUNT_TAUROS_14
	const EVENT_FOUGHT_WILD_HUNT_TAUROS_15
	const EVENT_FOUGHT_WILD_HUNT_TAUROS_16
	const EVENT_FOUGHT_WILD_HUNT_TAUROS_17
	const EVENT_FOUGHT_UNOWN_A
	const EVENT_FOUGHT_UNOWN_B
	const EVENT_FOUGHT_UNOWN_C
	const EVENT_FOUGHT_UNOWN_D
	const EVENT_FOUGHT_UNOWN_E
	const EVENT_FOUGHT_UNOWN_F
	const EVENT_FOUGHT_UNOWN_G
	const EVENT_FOUGHT_UNOWN_H
	const EVENT_FOUGHT_UNOWN_I
	const EVENT_FOUGHT_UNOWN_J
	const EVENT_FOUGHT_UNOWN_K
	const EVENT_FOUGHT_UNOWN_L
	const EVENT_FOUGHT_UNOWN_M
	const EVENT_FOUGHT_UNOWN_N
	const EVENT_FOUGHT_UNOWN_O
	const EVENT_FOUGHT_UNOWN_P
	const EVENT_FOUGHT_UNOWN_Q
	const EVENT_FOUGHT_UNOWN_R
	const EVENT_FOUGHT_UNOWN_S
	const EVENT_FOUGHT_UNOWN_T
	const EVENT_FOUGHT_UNOWN_U
	const EVENT_FOUGHT_UNOWN_V
	const EVENT_FOUGHT_UNOWN_W
...
; Kanto story events
	...
	const EVENT_GOT_KANGASKHAN_FROM_SAGE
	const EVENT_VIRIDIAN_TRAINER_HOUSE_CLEARED
; Kanto hidden items
	const EVENT_DIGLETTS_CAVE_HIDDEN_MAX_REVIVE
	const EVENT_UNDERGROUND_PATH_HIDDEN_FULL_RESTORE
	const EVENT_UNDERGROUND_PATH_HIDDEN_MAX_REVIVE
	const EVENT_UNDERGROUND_PATH_HIDDEN_MAX_POTION
	const EVENT_UNDERGROUND_PATH_HIDDEN_MAX_ELIXER
	...
	const EVENT_ROUTE_26_HIDDEN_FULL_RESTORE
	...
	const EVENT_MT_MOON_HIDDEN_MAX_POTION
	const EVENT_MT_MOON_HIDDEN_MAX_REPEL
	const EVENT_MT_MOON_HIDDEN_FULL_HEAL
	const EVENT_MT_MOON_HIDDEN_ELIXER
	const EVENT_MT_MOON_B1_HIDDEN_FULL_RESTORE
	const EVENT_MT_MOON_B1_HIDDEN_MAX_ETHER
	const EVENT_MT_MOON_B1_HIDDEN_STAR_PIECE
	const EVENT_MT_MOON_B1_HIDDEN_ESCAPE_ROPE
	const EVENT_MT_MOON_B1_HIDDEN_REVIVAL_HERB
	const EVENT_MT_MOON_B2_HIDDEN_MAX_POTION
	const EVENT_MT_MOON_B2_HIDDEN_NUGGET
...
; Phone events
	...
	const EVENT_VALENCIA_PORT_SAILOR_AT_GANGWAY ; M3; was 'unused in Crystal'
...
; More Johto story events
	...
	const EVENT_CONTEST_OFFICER_HAS_MIST_STONE
	const EVENT_CONTEST_OFFICER_HAS_MIRACLEBERRY
...
; More Crystal-exclusive events in Johto
	...
	const EVENT_WADE_HAS_MIRACLEBERRY
	...
	const EVENT_FOUGHT_KAREN_AT_CIANWOOD
	...
	const EVENT_GOT_GRIP_CLAW_FROM_EARL
	const EVENT_GOT_GS_BALL_FROM_OAK
	const EVENT_GOT_SAFARI_LURE_FROM_MR_POKEMON
	const EVENT_MOUNT_MORTAR_2F_INSIDE_HIDDEN_RARE_CANDY
	const EVENT_MOUNT_MORTAR_1F_INSIDE_HIDDEN_ZINC
	const EVENT_MOUNT_MORTAR_1F_INSIDE_HIDDEN_KINGS_ROCK
	const EVENT_MOUNT_MORTAR_1F_INSIDE_HIDDEN_MIST_STONE
...
; Boarder
	...
	const EVENT_BEAT_BOARDER_DAMON
	const EVENT_BEAT_BOARDER_VINCE
; Sage
...
; Camper
	...
	const EVENT_BEAT_CAMPER_HARVEY
...
; Guitarist
	...
	const EVENT_BEAT_GUITARIST_JOVI
	const EVENT_BEAT_GUITARIST_HALEN
; Juggler
	const EVENT_BEAT_JUGGLER_IRWIN
	const EVENT_BEAT_JUGGLER_FRITZ
	const EVENT_BEAT_JUGGLER_HORTON
	const EVENT_BEAT_JUGGLER_CLIFF
	const EVENT_BEAT_JUGGLER_LEVI
	const EVENT_BEAT_JUGGLER_CALEB
; Gentleman
...
; Scientist
	...
	const EVENT_BEAT_SCIENTIST_WERNER
	const EVENT_BEAT_SCIENTIST_ENRICO
	const EVENT_BEAT_SCIENTIST_NIELS
	const EVENT_BEAT_SCIENTIST_EARNEST
	const EVENT_BEAT_SCIENTIST_MAX
	const EVENT_BEAT_SCIENTIST_ERWIN
	const EVENT_BEAT_SCIENTIST_JAYJAY
	const EVENT_BEAT_SCIENTIST_CARL
	const EVENT_BEAT_SCIENTIST_KIP
	const EVENT_BEAT_SCIENTIST_MILES
; Blackbelt
	const EVENT_BEAT_BLACKBELT_KENJI
	const EVENT_BEAT_BLACKBELT_YOSHI
	const EVENT_BEAT_BLACKBELT_DOMUN
...
; Beauty
	...
	const EVENT_GOT_LIGHT_CLAY_FROM_ANGELICA
...
; PokefanM
	...
	const EVENT_BEAT_POKEFANM_JERRED
	const EVENT_BEAT_POKEFANM_JORDAN
	const EVENT_BEAT_POKEFANM_ALEX
; PokefanF
	const EVENT_BEAT_POKEFANF_BEVERLY
	const EVENT_BEAT_POKEFANF_RUTH
	const EVENT_BEAT_POKEFANF_JACKIE
	const EVENT_BEAT_POKEFANF_SONIA
...
; Pokemaniac
	...
	const EVENT_BEAT_POKEMANIAC_ASHTON
	const EVENT_BEAT_POKEMANIAC_FELIX
; GruntM
...
; GruntF
	...
	const EVENT_BEAT_ROCKET_GRUNTF_15
; Lass
	...
	const EVENT_BEAT_LASS_NONI
	const EVENT_BEAT_LASS_MARGE
...
; CooltrainerM
	...
	const EVENT_BEAT_COOLTRAINERM_LOGAN
	const EVENT_BEAT_COOLTRAINERM_TRAVIS
; CooltrainerF
	...
	const EVENT_BEAT_COOLTRAINERF_GALEN
	const EVENT_BEAT_COOLTRAINERF_KELSEY
	const EVENT_BEAT_COOLTRAINERF_NINA
	const EVENT_BEAT_COOLTRAINERF_AMBER
; ExecutiveF
	const EVENT_BEAT_ROCKET_EXECUTIVEF_1
	const EVENT_BEAT_ROCKET_EXECUTIVEF_2
	const EVENT_BEAT_ROCKET_EXECUTIVEF_3
; ExecutiveM
...
; Super Nerd
	...
	const EVENT_BEAT_SUPER_NERD_OTTO
; Medium
...
; Skier
	...
	const EVENT_BEAT_SKIER_NOELLE
	const EVENT_BEAT_SKIER_FLORA
; SwimmerM
...
; Crystal-exclusive trainer flags
	...
	const EVENT_BEAT_TWINS_SAM_AND_PAM
	...
	const EVENT_ANGELICA_GAVE_INTRO
	const EVENT_RUINS_OF_ALPH_ROCKETS
	const EVENT_RUINS_OF_ALPH_OUTSIDE_EXECUTIVES
	const EVENT_DEFEATED_RUINS_OF_ALPH_ROCKETS
	const EVENT_ICE_PATH_1F_RIVAL
...
; Johto itemballs
	...
	const EVENT_SAFFRON_UNDERGROUND_WAREHOUSE_NUGGET
	const EVENT_BURNED_TOWER_1F_HEAT_ROCK
	...
	const EVENT_UNION_CAVE_1F_HIDDEN_HYPER_POTION
	...
	const EVENT_SAFFRON_UNDERGROUND_SWITCH_ROOM_SMOKE_BALL
	const EVENT_SAFFRON_UNDERGROUND_SWITCH_ROOM_FULL_HEAL
	const EVENT_GOLDENROD_DEPT_STORE_B1F_ETHER
	const EVENT_GOLDENROD_DEPT_STORE_B1F_NUGGET
	const EVENT_GOLDENROD_DEPT_STORE_B1F_BURN_HEAL
	const EVENT_GOLDENROD_DEPT_STORE_B1F_ULTRA_BALL
	const EVENT_SAFFRON_UNDERGROUND_WAREHOUSE_MAX_ETHER
	const EVENT_SAFFRON_UNDERGROUND_WAREHOUSE_TM_SLEEP_TALK
	const EVENT_MOUNT_MORTAR_1F_OUTSIDE_MAX_ETHER
	...
	const EVENT_MOUNT_MORTAR_2F_INSIDE_SMOOTH_ROCK
	...
	const EVENT_WHIRL_ISLAND_SW_MIST_STONE
	...
	const EVENT_SILVER_CAVE_ROOM_1_FULL_RESTORE
	const EVENT_SILVER_CAVE_ITEM_ROOMS_MAX_REVIVE
	const EVENT_SILVER_CAVE_ITEM_ROOMS_FULL_RESTORE
	const EVENT_SILVER_CAVE_ITEM_ROOMS_REVIVAL_HERB
	const EVENT_SILVER_CAVE_ITEM_ROOMS_MIST_STONE
	const EVENT_DARK_CAVE_VIOLET_ENTRANCE_ETHER
	...
	const EVENT_DARK_CAVE_BLACKTHORN_ENTRANCE_MIST_STONE
	...
	const EVENT_ROUTE_42_HYPER_POTION
	...
	const EVENT_SILVER_CAVE_UNDERBELLY_SUN_STONE
	const EVENT_SILVER_CAVE_UNDERBELLY_NUGGET
	const EVENT_SILVER_CAVE_UNDERBELLY_ZINC
	const EVENT_SILVER_CAVE_UNDERBELLY_MAX_POTION
; Johto people
	...
	const EVENT_RUINS_OF_ALPH_RESEARCH_CENTER_ROCKET
	const EVENT_ELM_NOT_AT_RUINS_RESEARCH_CENTER
	...
	const EVENT_DARK_CAVE_MEW
	const EVENT_TOHJO_FALLS_MEWTWO
	const EVENT_SEAFOAM_CAVES_ARTICUNO
	const EVENT_ROCK_TUNNEL_ZAPDOS
	...
	const EVENT_BURNED_TOWER_1F_KAREN
...
; Kanto people
	...
	const EVENT_ROUTE5_SNORLAX
	const EVENT_ROUTE8_SNORLAX
	...
	const EVENT_LAVENDER_TOWN_ROCKET_SCOUT
	const EVENT_RIVAL_LAV_RADIO_TOWER
	const EVENT_RIVAL_LAV_RADIO_TOWER_2F
	const EVENT_LAV_RADIO_TOWER_RANGER_HIDDEN
	const EVENT_CLEARED_CERULEAN_CAVE
	const EVENT_DISCOVERED_CERULEAN_CAVE
; Kanto itemballs
	...
	const EVENT_MT_MOON_NUGGET
	const EVENT_MT_MOON_PP_UP
	const EVENT_MT_MOON_REVIVE
	const EVENT_MT_MOON_MOON_STONE
	const EVENT_MT_MOON_B1_RARE_CANDY
	const EVENT_MT_MOON_B1_CARBOS
	const EVENT_MT_MOON_B1_MAX_REVIVE
	const EVENT_MT_MOON_B1_ULTRA_BALL
	const EVENT_MT_MOON_B2_MOON_STONE
	const EVENT_MT_MOON_B2_FULL_RESTORE
	const EVENT_MT_MOON_B2_CALCIUM
	const EVENT_MT_MOON_PATH_MAX_POTION
	const EVENT_MT_MOON_PATH_FULL_HEAL
; New to Crystal
	...
	const EVENT_PICKED_UP_AMULET_COIN_FROM_HO_OH_ITEM_ROOM
	const EVENT_PICKED_UP_SACRED_ASH_FROM_HO_OH_ITEM_ROOM
	const EVENT_PICKED_UP_REVIVAL_HERB_FROM_HO_OH_ITEM_ROOM
	const EVENT_PICKED_UP_SUN_STONE_FROM_HO_OH_ITEM_ROOM
	const EVENT_PICKED_UP_GOLD_BERRY_FROM_KABUTO_ITEM_ROOM
	const EVENT_PICKED_UP_MYSTERYBERRY_FROM_KABUTO_ITEM_ROOM
	...
	const EVENT_PICKED_UP_MIST_STONE_FROM_OMANYTE_ITEM_ROOM
	const EVENT_PICKED_UP_STARDUST_FROM_OMANYTE_ITEM_ROOM
	const EVENT_PICKED_UP_STAR_PIECE_FROM_OMANYTE_ITEM_ROOM
	const EVENT_PICKED_UP_BRIGHTPOWDER_FROM_AERODACTYL_ITEM_ROOM
	...
	const EVENT_ICE_PATH_1F_ICY_ROCK
	...
	const EVENT_SILVER_CAVE_ROOM_2_ELIXER
	...
	const EVENT_DARK_CAVE_VIOLET_ENTRANCE_NUGGET
	const EVENT_DARK_CAVE_VIOLET_ENTRANCE_RARE_CANDY
	const EVENT_DARK_CAVE_VIOLET_ENTRANCE_REVIVE
	const EVENT_DARK_CAVE_VIOLET_ENTRANCE_PROTEIN
	const EVENT_DARK_CAVE_VIOLET_ENTRANCE_KINGS_ROCK
	const EVENT_BATTLE_TOWER_OPEN_CIVILIANS
; Greenhouse plot flags (WATERED must immediately follow GROWN for each plot)
	const EVENT_GREENHOUSE_PLOT1_GROWN
	const EVENT_GREENHOUSE_PLOT1_WATERED
	const EVENT_GREENHOUSE_PLOT2_GROWN
	const EVENT_GREENHOUSE_PLOT2_WATERED
	const EVENT_GREENHOUSE_PLOT3_GROWN
	const EVENT_GREENHOUSE_PLOT3_WATERED
	const EVENT_GREENHOUSE_PLOT4_GROWN
	const EVENT_GREENHOUSE_PLOT4_WATERED
; Unused: next 44 events
	const EVENT_GOT_ZINC_FROM_ANTHONY
	const EVENT_ANTHONY_ZINC
