...
; NPCTrades indexes (see data/events/npc_trades.asm)
	...
	const NPC_TRADE_BARRY  ; 7
	const NPC_TRADE_TERRY  ; 8
	const NPC_TRADE_RONIN  ; 9
	const NPC_TRADE_DARREL ; 10
	const NPC_TRADE_ELYSSA ; 11
	const NPC_TRADE_OSCAR  ; 12
	const NPC_TRADE_LINDA  ; 13
