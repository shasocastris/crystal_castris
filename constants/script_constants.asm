...
; FruitTreeItems indexes (see data/items/fruit_trees.asm)
	...
	const FRUITTREE_CHERRYGROVE_CITY_1  ; 1f
	const FRUITTREE_CHERRYGROVE_CITY_2  ; 20
	const FRUITTREE_CHERRYGROVE_CITY_3  ; 21
	const FRUITTREE_CHERRYGROVE_CITY_4  ; 22
