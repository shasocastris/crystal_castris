...
; SACRED_ASH
	item_attribute 20000, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_CLOSE, ITEMMENU_NOUSE
; MYSTIC_DEW
	item_attribute 20000, HELD_NONE, -1, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_PARTY
...
; MIRACLE_SEED
	item_attribute 1000, HELD_GRASS_BOOST, 10, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; POISON_BARB
	item_attribute 1000, HELD_POISON_BOOST, 10, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; SILVERPOWDER
	item_attribute 1000, HELD_BUG_BOOST, 10, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; CHARCOAL
	item_attribute 1000, HELD_FIRE_BOOST, 10, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; MYSTIC_WATER
	item_attribute 1000, HELD_WATER_BOOST, 10, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; NEVERMELTICE
	item_attribute 1000, HELD_ICE_BOOST, 10, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; MAGNET
	item_attribute 1000, HELD_ELECTRIC_BOOST, 10, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; BLACKBELT_I
	item_attribute 1000, HELD_FIGHTING_BOOST, 10, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; HARD_STONE
	item_attribute 1000, HELD_ROCK_BOOST, 10, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; SOFT_SAND
	item_attribute 1000, HELD_GROUND_BOOST, 10, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; TWISTEDSPOON
	item_attribute 1000, HELD_PSYCHIC_BOOST, 10, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; PINK_BOW
	item_attribute 1000, HELD_NORMAL_BOOST, 10, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; POLKADOT_BOW
	item_attribute 1000, HELD_FAIRY_BOOST, 10, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; SHARP_BEAK
	item_attribute 1000, HELD_FLYING_BOOST, 10, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; SPELL_TAG
	item_attribute 1000, HELD_GHOST_BOOST, 10, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; BLACKGLASSES
	item_attribute 1000, HELD_DARK_BOOST, 10, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; METAL_COAT
	item_attribute 1000, HELD_STEEL_BOOST, 10, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_NOUSE
; DRAGON_FANG
	item_attribute 1000, HELD_DRAGON_BOOST, 10, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE

; BERSERK_GENE
	item_attribute 4000, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; BRIGHTPOWDER
	item_attribute 4000, HELD_BRIGHTPOWDER, 20, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; QUICK_CLAW
	item_attribute 4000, HELD_QUICK_CLAW, 60, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; KINGS_ROCK
	item_attribute 4000, HELD_FLINCH, 30, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_NOUSE
; AMULET_COIN
	item_attribute 20000, HELD_AMULET_COIN, 10, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; CLEANSE_TAG
...
; LUCKY_PUNCH
	item_attribute 4000, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; METAL_POWDER
	item_attribute 4000, HELD_METAL_POWDER, 10, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
...
; POISON_GUARD
	item_attribute 4000, HELD_PREVENT_POISON, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; BURN_GUARD
	item_attribute 4000, HELD_PREVENT_BURN, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; FREEZE_GUARD
	item_attribute 4000, HELD_PREVENT_FREEZE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; SLEEP_GUARD
	item_attribute 4000, HELD_PREVENT_SLEEP, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; PARLYZ_GUARD
	item_attribute 4000, HELD_PREVENT_PARALYZE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; CONFUSEGUARD
	item_attribute 4000, HELD_PREVENT_CONFUSE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
...
; SMOOTH_ROCK
	item_attribute 4000, HELD_PROLONG_SAND, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; ICY_ROCK
...
; SAFARI_LURE
	item_attribute 4000, HELD_CATCH_CHANCE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
...
; RAINBOW_WING
	item_attribute 0, HELD_NONE, 0, CANT_SELECT | CANT_TOSS, KEY_ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; POKE_FLUTE
	item_attribute 0, HELD_NONE, 0, CANT_SELECT | CANT_TOSS, KEY_ITEM, ITEMMENU_CURRENT, ITEMMENU_CURRENT
.IndirectEnd::
...
; ATK_UP_BERRY
	item_attribute 200, HELD_ATTACK_UP, 0, CANT_SELECT, BERRIES, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; DEF_UP_BERRY
	item_attribute 200, HELD_DEFENSE_UP, 0, CANT_SELECT, BERRIES, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; SPD_UP_BERRY
	item_attribute 200, HELD_SPEED_UP, 0, CANT_SELECT, BERRIES, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; SPA_UP_BERRY
	item_attribute 200, HELD_SP_ATTACK_UP, 0, CANT_SELECT, BERRIES, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; SPF_UP_BERRY
	item_attribute 200, HELD_SP_DEFENSE_UP, 0, CANT_SELECT, BERRIES, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; ACC_UP_BERRY
	item_attribute 200, HELD_ACCURACY_UP, 0, CANT_SELECT, BERRIES, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; EVN_UP_BERRY
	item_attribute 200, HELD_EVASION_UP, 0, CANT_SELECT, BERRIES, ITEMMENU_NOUSE, ITEMMENU_NOUSE
