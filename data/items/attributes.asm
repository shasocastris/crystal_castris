...
; ENERGYPOWDER
	item_attribute 500, HELD_NONE, 50, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_PARTY
; ENERGY_ROOT
	item_attribute 800, HELD_NONE, 200, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_PARTY
; HEAL_POWDER
...
; MYSTIC_DEW
	item_attribute 20000, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_PARTY
...
; METAL_COAT
	item_attribute 1000, HELD_STEEL_BOOST, 20, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_NOUSE
; DRAGON_FANG
...
; MAGNA_PLANT
	item_attribute 7000, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_CURRENT, ITEMMENU_NOUSE
; TROPIC_PLANT
	item_attribute 8000, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_CURRENT, ITEMMENU_NOUSE
; JUMBO_PLANT
	item_attribute 10000, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_CURRENT, ITEMMENU_NOUSE

; PINKBED
	item_attribute 45500, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_CURRENT, ITEMMENU_NOUSE
; POLKADOTBED
	item_attribute 52000, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_CURRENT, ITEMMENU_NOUSE
; PIKACHUBED
	item_attribute 65000, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_CURRENT, ITEMMENU_NOUSE

; NES
	item_attribute 7500, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_CURRENT, ITEMMENU_NOUSE
; N64
	item_attribute 10000, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_CURRENT, ITEMMENU_NOUSE
; VIRTUALBOY
	item_attribute 5000, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_CURRENT, ITEMMENU_NOUSE
; FCOM
	item_attribute 5000, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_CURRENT, ITEMMENU_NOUSE

; REDCARPET
	item_attribute 12500, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_CURRENT, ITEMMENU_NOUSE
; BLUECARPET
	item_attribute 12500, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_CURRENT, ITEMMENU_NOUSE
; YELLOWCARPET
	item_attribute 12500, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_CURRENT, ITEMMENU_NOUSE
...
; PIKACHU_POSTER
	item_attribute 7500, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_CURRENT, ITEMMENU_NOUSE
; CLEFAIRY_POSTER
	item_attribute 4000, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_CURRENT, ITEMMENU_NOUSE
; JIGGLYPUFF_POSTER
	item_attribute 5000, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_CURRENT, ITEMMENU_NOUSE
.IndirectEnd::
