...
ENDM
	...
	map_attributes CherrygroveCity, CHERRYGROVE_CITY, $05, NORTH | EAST, OW_WEATHER_CHERRY_BLOSSOMS | OW_WEATHER_SPRING
	...
	connection north, Route36, ROUTE_36, 6
	...
	connection south, Route35, ROUTE_35, -6
	...
	map_attributes GoldenrodUndergroundEntrances, GOLDENROD_UNDERGROUND_ENTRANCES, $00, 0
	map_attributes GoldenrodDeptStoreB1F, GOLDENROD_DEPT_STORE_B1F, $00, 0
	map_attributes SaffronUndergroundWarehouse, SAFFRON_UNDERGROUND_WAREHOUSE, $00, 0
	map_attributes SaffronUndergroundSwitchRoom, SAFFRON_UNDERGROUND_SWITCH_ROOM, $00, 0
	...
	map_attributes MountMoonB1, MOUNT_MOON_B1, $09, 0
	map_attributes MountMoonB2, MOUNT_MOON_B2, $09, 0
	map_attributes MountMoonPath, MOUNT_MOON_PATH, $09, 0
	...
	map_attributes SafariZone, SAFARI_ZONE, $13, 0
	map_attributes VictoryRoad, VICTORY_ROAD, $1d, 0
	map_attributes SeafoamCaves, SEAFOAM_CAVES, $19, 0
	...
	map_attributes LakeOfRageMoveReminderHouse, LAKE_OF_RAGE_MOVE_REMINDER_HOUSE, $00, 0
	...
	map_attributes VioletCemetery, VIOLET_CEMETERY, $00, 0
	...
	map_attributes GoldenrodGlitterAndGrace, GOLDENROD_GLITTER_AND_GRACE, $00, 0
	map_attributes GoldenrodPokecomCenter, GOLDENROD_POKECOM_CENTER, $00, 0
	...
	map_attributes Route8UndergroundPathEntrance, ROUTE_5_UNDERGROUND_PATH_ENTRANCE, $00, 0
	...
	map_attributes Route7UndergroundPathEntrance, ROUTE_5_UNDERGROUND_PATH_ENTRANCE, $00, 0
