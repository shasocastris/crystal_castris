...
MapGroup_Valencia:
	table_width MAP_LENGTH
	map ValenciaPort,   TILESET_PORT,  ROUTE, LANDMARK_VALENCIA_ISLAND, MUSIC_VERMILION_CITY, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map ValenciaIsland, TILESET_JOHTO, TOWN,  LANDMARK_VALENCIA_ISLAND, MUSIC_VERMILION_CITY, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map ShamoutiPassage, TILESET_JOHTO, ROUTE, LANDMARK_SHAMOUTI_PASSAGE, MUSIC_VERMILION_CITY, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map ShamoutiIsland, TILESET_JOHTO, TOWN,  LANDMARK_SHAMOUTI_ISLAND, MUSIC_VERMILION_CITY, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map ShamoutiCave, TILESET_CAVE, CAVE,     LANDMARK_SHAMOUTI_CAVE, MUSIC_VERMILION_CITY, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
