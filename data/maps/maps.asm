...
MapGroup_Dungeons:
	...
	map CeruleanCave, TILESET_DARK_CAVE, INDOOR, LANDMARK_CERULEAN_CITY, MUSIC_DARK_CAVE, TRUE, PALETTE_NITE | IN_DARKNESS, FISHGROUP_DRATINI
	map CeruleanBase1, TILESET_UNDERGROUND, INDOOR, LANDMARK_CERULEAN_CITY, MUSIC_ROCKET_HIDEOUT, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map CeruleanBase2, TILESET_UNDERGROUND, INDOOR, LANDMARK_CERULEAN_CITY, MUSIC_ROCKET_HIDEOUT, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map CeruleanBase3, TILESET_FACILITY, INDOOR, LANDMARK_CERULEAN_CITY, MUSIC_ROCKET_HIDEOUT, TRUE, PALETTE_NITE, FISHGROUP_SHORE
