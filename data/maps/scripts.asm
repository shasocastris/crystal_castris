...
INCLUDE "maps/GoldenrodGlitterAndGrace.asm"
INCLUDE "maps/GoldenrodPokecomCenter.asm"
...
INCLUDE "maps/LakeOfRageMoveReminderHouse.asm"
...
INCLUDE "maps/PewterForge.asm"
INCLUDE "maps/CeladonGreenhouse.asm"
