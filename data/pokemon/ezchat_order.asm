...
.a:        db EKANS, ARBOK, SEAKING, ARIADOS, CROCONAW, UNOWN, ANNIHILAPE, -1
.i:        db EEVEE, GEODUDE, SPINARAK, PILOSWINE, ONIX, -1
.u:        db ARCANINE, SUDOWOODO, WEEPINBELL, VICTREEBEL, WOOPER, SWINUB, -1
.e:        db SKARMORY, AIPOM, AMBIPOM, ESPEON, HITMONCHAN, ELEKID, ELECTABUZZ, ELECTIVIRE, ENTEI, -1
...
.ku_gu:    db GLOOM, PINECO, GLIGAR, KRABBY, GRANBULL, CROBAT, GLACEON, GLISCOR, -1
...
.shi_ji:   db SEADRA, SHELLDER, VAPOREON, DEWGONG, MAGNEZONE, -1
...
.to_do:    db DODUO, DODRIO, SMEARGLE, KOFFING, TENTACRUEL, TOGETIC, TOGEKISS, TOGEPI, GOLDEEN, METAPOD, DONPHAN, HONCHKROW, RHYPERIOR, -1
...
.he_be_pe: db BAYLEEF, GRIMER, MUK, HERACROSS, HOUNDOOM, PERSIAN, LICKITUNG, LICKILICKY, -1
.ho_bo_po: db HO_OH, HOOTHOOT, PIDGEY, PONYTA, SKIPLOOM, PORYGON, PORYGON2, PORYGON_Z, -1
.ma:       db MAGCARGO, MAGMORTAR, SLUGMA, QUILAVA, BELLSPROUT, WEEZING, MARILL, AZUMARILL, ELECTRODE, MANKEY, MANTINE, MAMOSWINE, WEAVILE, -1
.mi:       db DRATINI, MEW, MEWTWO, MILTANK, -1
.mu:       db MISDREAVUS, MISMAGIUS, SMOOCHUM, -1
.me:       db MEGANIUM, DITTO, TENTACOOL, MAREEP, YANMEGA, -1
.mo:       db FLAAFFY, VENOMOTH, TANGELA, TANGROWTH, -1
...
.ri:       db CHARMELEON, CHARIZARD, URSARING, LEAFEON, -1
.ru:       db JYNX, LUGIA, -1
