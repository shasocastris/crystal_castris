	...
	tilecoll WATERFALL, WATERFALL, WATERFALL, WATERFALL ; 83
	tilecoll WALL, WALL, WALL, WATER ; 84
	tilecoll WALL, WALL, WATER, WATER ; 85
	tilecoll WALL, WALL, WATER, WALL ; 86
	tilecoll WATER, WALL, WATER, WATER ; 87
	tilecoll WALL, WATER, WALL, WATER ; 88
	tilecoll UP_WALL, UP_WALL, DOWN_WALL, DOWN_WALL ; 89
	tilecoll WATER, WALL, WATER, WALL ; 8a
	tilecoll WALL, WATER, WATER, WATER ; 8b
	tilecoll WATER, WALL, WATER, WALL ; 8c
	tilecoll WALL, WATER, WALL, WATER ; 8d
	tilecoll WALL, WATERFALL, WALL, WATERFALL ; 8e
	tilecoll WATERFALL, WALL, WATERFALL, WALL ; 8f
	tilecoll WATER, WATER, WATER, WATER ; 90
	tilecoll WATER, WATER, WATER, WATER ; 91
	tilecoll WARP_CARPET_UP, WALL, WATER, WALL ; 92
	tilecoll WATER, WALL, WARP_CARPET_DOWN, WALL ; 93
	tilecoll WALL, WARP_CARPET_UP, WALL, WATER ; 94
	tilecoll WALL, WATER, WALL, WARP_CARPET_DOWN ; 95
	tilecoll WALL, WALL, WALL, WALL ; 96
	tilecoll WALL, WALL, WALL, WALL ; 97
	tilecoll WALL, WATER, WALL, WATER ; 98
	tilecoll WATER, WALL, WATER, WALL ; 99
	tilecoll WALL, DOOR, FLOOR, FLOOR ; 9a
	tilecoll WALL, WALL, FLOOR, FLOOR ; 9b
	tilecoll WALL, WALL, WARP_SURF_LEFT, WATER ; 9c
	tilecoll WARP_SURF_LEFT, WATER, WARP_SURF_LEFT, WATER ; 9d
	tilecoll WATER, WARP_SURF_RIGHT, WATER, WARP_SURF_RIGHT ; 9e
	tilecoll WALL, WALL, WARP_SURF_RIGHT, WATER ; 9f
	tilecoll UP_WALL, FLOOR, FLOOR, FLOOR ; a0
	tilecoll FLOOR, UP_WALL, FLOOR, FLOOR ; a1
	tilecoll UP_WALL, UP_WALL, FLOOR, FLOOR ; a2
	tilecoll LEFT_WALL, RIGHT_WALL, LEFT_WALL, RIGHT_WALL ; a3
	tilecoll UP_WALL, FLOOR, FLOOR, FLOOR ; a4
	tilecoll FLOOR, UP_WALL, FLOOR, FLOOR ; a5
	tilecoll UP_WALL, UP_WALL, FLOOR, FLOOR ; a6
	tilecoll WALL, WALL, WATER, WATER ; a7
