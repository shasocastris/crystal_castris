...
MortyGroup:
	...
	dw SMEARGLE
	dw LIGHT_CLAY
	dw SPORE, BATON_PASS, REFLECT, LIGHT_SCREEN
	db 30
	dw GENGAR
	dw NO_ITEM
	...
	dw HAUNTER
	dw BRIGHTPOWDER
	dw PSYCHIC_M, THUNDERBOLT, NIGHT_SHADE, TOXIC
	db 28
	dw MISDREAVUS
	dw FOCUS_BAND
...
JasmineGroup:
	...
	dw SKARMORY
	dw SCOPE_LENS
	dw DRILL_PECK, TOXIC, SPIKES, WHIRLWIND
	db 38
	dw MAGNETON
	dw KINGS_ROCK
...
Rival1Group:
	...
	db 26
	dw HAUNTER
	dw SHADOW_BALL, NIGHT_SHADE, MEAN_LOOK, CURSE
	db 24
	dw MAGNEMITE
	dw FLASH, SPARK, THUNDER_WAVE, SONICBOOM
	db 30
	dw GOLBAT
	dw LEECH_LIFE, WING_ATTACK, BITE, CONFUSE_RAY
	db 27
	dw BAYLEEF
	dw LEECH_SEED, REFLECT, RAZOR_LEAF, POISONPOWDER
	db -1 ; end
	...
	db 27
	dw QUILAVA
	dw REVERSAL, SMOKESCREEN, EMBER, QUICK_ATTACK
	db -1 ; end
	...
	db 27
	dw CROCONAW
	dw THRASH, ANCIENTPOWER, WATER_GUN, BITE
	db -1 ; end
	...
	db 34
	dw MAGNETON
	dw TRI_ATTACK, SPARK, FLASH, SPIKE_CANNON
	db 36
	dw HAUNTER
	dw SHADOW_BALL, NIGHT_SHADE, CONFUSE_RAY, CURSE
	db 39
	dw SNEASEL
	dw THIEF, ICE_PUNCH, SCREECH, COUNTER
	db 39
	dw MEGANIUM
	dw LEECH_SEED, PETAL_DANCE, STRENGTH, BODY_SLAM
	db -1 ; end
	...
	db 39
	dw FERALIGATR
	dw SURF, ANCIENTPOWER, CRUNCH, EARTHQUAKE
	db -1 ; end
	...
	db 44
	dw SNEASEL
	dw THIEF, ICE_PUNCH, SCREECH, REFLECT
	db 48
	dw GOLBAT
	dw LEECH_LIFE, BITE, CONFUSE_RAY, WING_ATTACK
	db 45
