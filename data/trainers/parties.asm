...
;	dw DODRIO
;	dw SHARP_BEAK
;	dw TRI_ATTACK, DRILL_PECK, STEEL_WING, MUD_SLAP
;	db 54
;	dw SKARMORY
;	dw QUICK_CLAW
;	dw MUD_SLAP, DRILL_PECK, SKY_ATTACK, STEEL_WING
;	db 57
;	dw GLIGAR
;	dw FOCUS_BAND
;	dw METAL_CLAW, WING_ATTACK, EARTHQUAKE, SLUDGE_BOMB
;	db 60
;	dw PIDGEOT
;	dw MIRACLEBERRY
...
GruntMGroup:
	...
	next_list_item ; GRUNTM (20), Team Rocket Hideout
	db "GRUNT@", TRAINERTYPE_NORMAL
	db 17
	dw DROWZEE
	db 19
	...
	next_list_item ; GRUNTM (21), Team Rocket Hideout
	db "GRUNT@", TRAINERTYPE_NORMAL
	db 16
	dw ZUBAT
	db 17
