...
YoungsterGroup:
	...
	db 45
	dw RATICATE
	dw DOUBLE_EDGE, QUICK_ATTACK, HYPER_FANG, PURSUIT
	db -1 ; end
...
BirdKeeperGroup:
	...
	db 58
	dw TOGETIC
	dw GIGA_DRAIN, ANCIENTPOWER, MOONBLAST, AIR_SLASH
	db -1 ; end
...
CooltrainerMGroup:
	...
	db 51
	dw FLAREON
	dw FLAMETHROWER, QUICK_ATTACK, BITE, DIG
	db -1 ; end
	...
	db 51
	dw QUAGSIRE
	dw WATERFALL, SLAM, AMNESIA, EARTHQUAKE
	db 51
	dw EXEGGUTOR
...
BurglarGroup:
	...
	db 62
	dw ARCANINE
	dw FLAMETHROWER, TAKE_DOWN, CRUNCH, ROAR
	db 62
	dw WEEZING
...
PicnickerGroup:
	...
	db 46
	dw VENUSAUR
	dw SOLARBEAM, RAZOR_LEAF, HEADBUTT, SLUDGE_BOMB
	db -1 ; end
...
CamperGroup:
	...
	db 71
	dw RATICATE
	dw HYPER_FANG, CRUNCH, QUICK_ATTACK, SUPER_FANG
	db 71
	dw FEAROW
