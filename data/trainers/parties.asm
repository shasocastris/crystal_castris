...
BugsyGroup:
	...
	dw SUDOWOODO
	dw QUICK_CLAW
	dw KARATE_CHOP, STRENGTH, ROCK_SLIDE, EARTHQUAKE
	db 70
	dw QUAGSIRE
	dw BRIGHTPOWDER
...
WhitneyGroup:
	...
	dw MILTANK
	dw KINGS_ROCK
	dw STOMP, REVERSAL, EARTHQUAKE, NOURISHMENT
	db -1 ; end
...
ChuckGroup:
	...
	dw HITMONTOP
	dw BERRY_JUICE
	dw ROLLING_KICK, PROTECT, MACH_PUNCH, ROCK_SMASH
	db -1 ; end
...
JasmineGroup:
	...
	dw FORRETRESS
	dw QUICK_CLAW
	dw PIN_MISSILE, SELFDESTRUCT, ROLLOUT, SKULL_BASH
	db 44
	dw SCIZOR
	dw EVN_UP_BERRY
