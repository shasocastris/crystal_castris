...
BugContestResultsScript:
	...
	clearevent EVENT_CONTEST_OFFICER_HAS_MIST_STONE
	clearevent EVENT_CONTEST_OFFICER_HAS_MIRACLEBERRY
...
BugContestResults_SecondPlace:
	getitemname STRING_BUFFER_4, MIST_STONE
	farwritetext ContestResults_PlayerWonAPrizeText
	waitbutton
	verbosegiveitem MIST_STONE
	iffalse BugContestResults_NoRoomForMistStone
	sjump BugContestResults_ReturnAfterWinnersPrize

BugContestResults_ThirdPlace:
	getitemname STRING_BUFFER_4, MIRACLEBERRY
	farwritetext ContestResults_PlayerWonAPrizeText
	waitbutton
	verbosegiveitem MIRACLEBERRY
	iffalse BugContestResults_NoRoomForMiracleBerry
	sjump BugContestResults_ReturnAfterWinnersPrize
...
BugContestResults_NoRoomForMistStone:
	farwritetext BugContestPrizeNoRoomText
	promptbutton
	setevent EVENT_CONTEST_OFFICER_HAS_MIST_STONE
	sjump BugContestResults_ReturnAfterWinnersPrize

BugContestResults_NoRoomForMiracleBerry:
	farwritetext BugContestPrizeNoRoomText
	promptbutton
	setevent EVENT_CONTEST_OFFICER_HAS_MIRACLEBERRY
	sjump BugContestResults_ReturnAfterWinnersPrize
...
InitializeEventsScript:
	...
	setevent EVENT_LAV_RADIO_TOWER_RANGER_HIDDEN
	setevent EVENT_RUINS_OF_ALPH_OUTSIDE_EXECUTIVES
	...
	clearevent EVENT_RUINS_OF_ALPH_RESEARCH_CENTER_ROCKET
	...
	setevent EVENT_DARK_CAVE_MEW
	setevent EVENT_TOHJO_FALLS_MEWTWO
	setevent EVENT_SEAFOAM_CAVES_ARTICUNO
	setevent EVENT_ROCK_TUNNEL_ZAPDOS
	...
	setevent EVENT_CIANWOOD_CITY_KAREN
	setevent EVENT_TIN_TOWER_1F_KAREN
