...
DudunsparceAnimationIdle:    INCLUDE "gfx/pokemon/dudunsparc/anim_idle.asm"
...
CorsolaKantoAnimationIdle:    INCLUDE "gfx/pokemon/corsola_kanto/anim_idle.asm"
RaichuOrangeAnimationIdle:    INCLUDE "gfx/pokemon/raichu_orange/anim_idle.asm"
