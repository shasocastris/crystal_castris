...
class CrystalLevelCurveCalculator:
    ...
    def calculate_optimal_gym_levels(self, trainer_exp):
        ...
        gym_progression = [
            ...
            ('Lance', 'clair_to_elite_four'),
            ('Surge', 'elite_four_to_ltsurge'),
            ('Sabrina', 'ltsurge_to_sabrina'),
            ('Misty', 'sabrina_to_misty'),
            ('Erika', 'misty_to_erika'),
            ('Janine', 'erika_to_janine'),
            ('Brock', 'janine_to_brock'),
            ('Blaine', 'brock_to_blaine'),
            ('Blue', 'blaine_to_blue'),
        ]
    ...
    def generate_level_curve_report(self):
        ...
        current_levels = {
            ...
            'Chuck': 38, 'Jasmine': 42, 'Pryce': 45, 'Clair': 48, 'Lance': 60,
            'Surge': 56, 'Sabrina': 58, 'Misty': 57, 'Erika': 56,
            'Janine': 57, 'Brock': 54, 'Blaine': 62, 'Blue': 70,
        }
...
def generate_summary_report(team_sizes, output_dir):
    ...
    gym_leaders = ['Falkner', 'Bugsy', 'Whitney', 'Morty', 'Chuck', 'Jasmine', 'Pryce', 'Clair', 'Lance',
