...
INCLUDE "engine/events/restaurant.asm"
...
INCLUDE "engine/phone/scripts/lance.asm"
...
INCLUDE "engine/events/safari_move_tutor.asm"
...
INCLUDE "data/phone/text/lance.asm"
