...
CherrygrovePokecenter1FTeacherText:
	text "The MART upstairs"
	line "is very convenient"
	cont "for trainers."

	para "You can rest down"
	line "here and buy extra"
	cont "supplies when you"
	cont "are ready to head"
	cont "out."
	done
...
CherrygrovePokecenter1F_MapEvents:
	...
	warp_event  0,  7, CHERRYGROVE_MART, 1
