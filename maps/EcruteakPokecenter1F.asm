...
EcruteakPokecenter1F_BillText2:
	...
	line "on ROUTE 38 that"
	cont "set off the local"
	cont "TAUROS herd."

	para "They've gone ber-"
	line "serk, attacking"
	cont "anything nearby."

	para "If the rampage"
	line "spreads, it could"
	cont "trigger a WILD"
	cont "HUNT."

	para "ECRUTEAK could be"
	line "completely over-"
	cont "run."

	para "MORTY and KAREN"
	line "are at the BURNED"
	cont "TOWER right now"

	para "and checking for"
	line "any clues in the"
	cont "ruins."

	para "Did the unsafe"
	line "structure cause a"
	cont "#MON to die?"
