...
.NotEnoughPokemon:
	writetext GoldenrodCityMoveTutorNeedMorePokemonText
	waitbutton
	closetext
	end
...
GoldenrodCityCooltrainerF1Text:
	text "There's an old guy"
	line "in town that will"
	cont "teach your #MON"
	cont "really good moves,"

	para "but only if you've"
	line "caught a bunch of"
	cont "#MON."
	done
...
GoldenrodCityMoveTutorNeedMorePokemonText:
	text "Hmm, you seem like"
	line "a promising young"
	cont "trainer, but…"
	
	para "My advanced moves"
	line "require deep"
	...
	cont "least 50 different"
	cont "#MON species!"
	
	para "Experience with"
	line "many #MON will"
	cont "help you use these"
	cont "moves effectively."
	done
...
GoldenrodCity_MapEvents:
	...
	warp_event 33,  9, GOLDENROD_UNDERGROUND_ENTRANCES, 11
	...
	warp_event  9,  5, GOLDENROD_UNDERGROUND_ENTRANCES, 5
	warp_event 11, 29, GOLDENROD_UNDERGROUND_ENTRANCES, 2
	warp_event 15, 27, GOLDENROD_POKECOM_CENTER, 2
	warp_event 26, 15, GOLDENROD_GLITTER_AND_GRACE, 1
	warp_event 35, 27, GOLDENROD_UNDERGROUND_ENTRANCES, 8
	...
	bg_event  8,  6, BGEVENT_READ, GoldenrodCityUndergroundSign
	bg_event 12, 30, BGEVENT_READ, GoldenrodCityUndergroundSign
	bg_event 34, 29, BGEVENT_READ, GoldenrodCityUndergroundSign
	...
	def_object_events
	object_event  7, 18, SPRITE_POKEFAN_M, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, GoldenrodCityPokefanMScript, -1
	object_event 30, 17, SPRITE_YOUNGSTER, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, GoldenrodCityYoungster1Script, -1
	object_event 12, 16, SPRITE_COOLTRAINER_F, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, GoldenrodCityCooltrainerF1Script, -1
	...
	object_event 19, 17, SPRITE_YOUNGSTER, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, GoldenrodCityYoungster2Script, -1
	object_event 17, 10, SPRITE_LASS, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 2, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, GoldenrodCityLassScript, -1
	object_event 11, 27, SPRITE_GRAMPS, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 1, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, GoldenrodCityGrampsScript, -1
