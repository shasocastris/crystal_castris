...
GoldenrodDeptStoreB1F_MapEvents:
	...
	object_event 14,  2, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, GoldenrodDeptStoreB1FNugget, EVENT_GOLDENROD_DEPT_STORE_B1F_NUGGET
