...
GoldenrodUndergroundEntrances_MapEvents:
	...
	def_warp_events
	warp_event  5,  5, GOLDENROD_UNDERGROUND, 2
	warp_event  4,  9, GOLDENROD_CITY, 14
	warp_event  5,  9, GOLDENROD_CITY, 14
	warp_event 21,  5, GOLDENROD_UNDERGROUND, 1
	warp_event 20,  9, GOLDENROD_CITY, 13
	warp_event 21,  9, GOLDENROD_CITY, 13
	warp_event  5, 19, GOLDENROD_UNDERGROUND, 7
	warp_event  4, 23, GOLDENROD_CITY, 17
	warp_event  5, 23, GOLDENROD_CITY, 17
	...
	def_object_events
	object_event  3,  7, SPRITE_TEACHER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, GoldenrodUndergroundEntrancesTeacherScript, -1
	object_event 19,  7, SPRITE_SUPER_NERD, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, GoldenrodUndergroundEntrancesSuperNerdScript, -1
	object_event  3, 20, SPRITE_FISHER, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, GoldenrodUndergroundEntrancesFisherScript, -1
