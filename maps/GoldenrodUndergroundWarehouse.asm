...
GoldenrodUndergroundWarehouseTwistedSpoon:
...
GoldenrodUndergroundWarehouse_MapEvents:
	...
	object_event  2,  1, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, GoldenrodUndergroundWarehouseTwistedSpoon, EVENT_GOLDENROD_UNDERGROUND_WAREHOUSE_TWISTEDSPOON
