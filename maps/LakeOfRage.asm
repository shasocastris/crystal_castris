...
LakeOfRage_MapEvents:
	...
	def_warp_events
	warp_event  7,  3, LAKE_OF_RAGE_MOVE_REMINDER_HOUSE, 1
	...
	object_event 18, 28, SPRITE_GRAMPS, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, LakeOfRageGrampsScript, -1
	...
	object_event 20, 25, SPRITE_GYARADOS, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, RedGyarados, EVENT_LAKE_OF_RAGE_RED_GYARADOS
