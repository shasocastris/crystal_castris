...
LavRadioTower3F_MapEvents:
	...
	object_event 10,  6, SPRITE_COOLTRAINER_M, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 0, TrainerGruntM34, EVENT_RADIO_TOWER_ROCKET_TAKEOVER
