...
Route20_MapEvents:
	...
	warp_event 30,  5, SEAFOAM_CAVES, 1
	...
	object_event  6,  7, SPRITE_SWIMMER_GUY, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 1, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 1, TrainerSwimmermTony, -1
