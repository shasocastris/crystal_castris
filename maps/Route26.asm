...
TrainerJugglerLevi:
	trainer JUGGLER, LEVI, EVENT_BEAT_JUGGLER_LEVI, JugglerLeviSeenText, JugglerLeviBeatenText, 0, .Script

.Script:
	opentext
	writetext JugglerLeviAfterBattleText
	waitbutton
	closetext
	end
...
JugglerLeviBeatenText:
	text "The real magic"
	line "was your skill!"
	done

JugglerLeviAfterBattleText:
	text "A true magician"
	line "never reveals"
	cont "their secrets!"
...
Route26_MapEvents:
	...
	object_event  2, 82, SPRITE_YOUNGSTER, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_PURPLE, OBJECTTYPE_TRAINER, 5, TrainerJugglerLevi, -1
