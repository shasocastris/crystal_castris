...
RuinsOfAlphAerodactylItemRoomBrightpowder:
...
RuinsOfAlphAerodactylItemRoom_MapEvents:
	...
	def_warp_events
	warp_event  3,  8, RUINS_OF_ALPH_AERODACTYL_CHAMBER, 5
	warp_event  4,  8, RUINS_OF_ALPH_AERODACTYL_CHAMBER, 5
	...
	def_object_events
	object_event  2,  6, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, RuinsOfAlphAerodactylItemRoomBrightpowder, EVENT_PICKED_UP_BRIGHTPOWDER_FROM_AERODACTYL_ITEM_ROOM
