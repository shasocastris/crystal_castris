...
SilverCaveRoom2_MapEvents:
	...
	def_warp_events
	warp_event 17, 31, SILVER_CAVE_UNDERBELLY, 2
	warp_event 23,  3, SILVER_CAVE_ROOM_3, 1
	warp_event 13, 21, SILVER_CAVE_ITEM_ROOMS, 1
	warp_event 11,  5, SILVER_CAVE_ITEM_ROOMS, 2
	warp_event 28, 11, SILVER_CAVE_ITEM_ROOMS, 3
	...
	object_event 23, 18, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, SilverCaveRoom2Elixer, EVENT_SILVER_CAVE_ROOM_2_ELIXER
