...
TeamRocketBaseB1F_MapEvents:
	...
	object_event 21, 12, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, TeamRocketBaseB1FFocusBand, EVENT_TEAM_ROCKET_BASE_B1F_FOCUS_BAND
